...
public extension DispatchQueue {
    ...
    func parMap<F: Concurrent, A, B, C, D, E, Z>(_ fa: Kind<F, A>,
                                                 _ fb: Kind<F, B>,
                                                 _ fc: Kind<F, C>,
                                                 _ fd: Kind<F, D>,
                                                 _ fe: Kind<F, E>,
    ...
    func parMap<F: Concurrent, A, B, C, D, E, G, Z>(_ fa: Kind<F, A>,
                                                    _ fb: Kind<F, B>,
                                                    _ fc: Kind<F, C>,
                                                    _ fd: Kind<F, D>,
                                                    _ fe: Kind<F, E>,
    ...
    func parMap<F: Concurrent, A, B, C, D, E, G, H, Z>(_ fa: Kind<F, A>,
                                                       _ fb: Kind<F, B>,
                                                       _ fc: Kind<F, C>,
                                                       _ fd: Kind<F, D>,
                                                       _ fe: Kind<F, E>,
    ...
    func parMap<F: Concurrent, A, B, C, D, E, G, H, I, Z>(_ fa: Kind<F, A>,
                                                          _ fb: Kind<F, B>,
                                                          _ fc: Kind<F, C>,
                                                          _ fd: Kind<F, D>,
                                                          _ fe: Kind<F, E>,
    ...
    func parMap<F: Concurrent, A, B, C, D, E, G, H, I, J, Z>(_ fa: Kind<F, A>,
                                                             _ fb: Kind<F, B>,
                                                             _ fc: Kind<F, C>,
                                                             _ fd: Kind<F, D>,
                                                             _ fe: Kind<F, E>,
...
public extension Kind where F: Concurrent & Bracket {
    ...
    static func cancelable(_ k: @escaping (@escaping Callback<F.E, A>) -> CancelToken<F>) -> Kind<F, A> {
