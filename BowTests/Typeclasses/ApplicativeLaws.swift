...
class ApplicativeLaws<F> {
    ...
    static func check<Appl, EqA>(applicative : Appl, eq : EqA) where Appl : Applicative, Appl.F == F, EqA : Eq, EqA.A == HK<F, Int> {
    ...
    private static func apIdentity<Appl, EqA>(applicative : Appl, eq : EqA) where Appl : Applicative, Appl.F == F, EqA : Eq, EqA.A == HK<F, Int> {
    ...
    private static func homomorphism<Appl, EqA>(applicative : Appl, eq : EqA) where Appl : Applicative, Appl.F == F, EqA : Eq, EqA.A == HK<F, Int> {
    ...
    private static func interchange<Appl, EqA>(applicative : Appl, eq : EqA) where Appl : Applicative, Appl.F == F, EqA : Eq, EqA.A == HK<F, Int> {
    ...
    private static func mapDerived<Appl, EqA>(applicative : Appl, eq : EqA) where Appl : Applicative, Appl.F == F, EqA : Eq, EqA.A == HK<F, Int> {
    ...
    private static func cartesianBuilderMap<Appl, EqA>(applicative : Appl, eq : EqA) where Appl : Applicative, Appl.F == F, EqA : Eq, EqA.A == HK<F, Int> {
    ...
    private static func cartesianBuilderTupled<Appl, EqA>(applicative : Appl, eq : EqA) where Appl : Applicative, Appl.F == F, EqA : Eq, EqA.A == HK<F, Int> {
        property("cartesian builder map") <- forAll() { (a : Int, b : Int, c : Int, d : Int, e : Int, f : Int, g : Int) in
