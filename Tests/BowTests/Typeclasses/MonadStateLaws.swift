...
class MonadStateLaws<F> {
    ...
    static func check<MonSt, EqF, EqUnit>(monadState : MonSt, eq : EqF, eqUnit : EqUnit) where MonSt : MonadState, MonSt.F == F, MonSt.S == Int, EqF : Eq, EqF.A == HK<F, Int>, EqUnit : Eq, EqUnit.A == HK<F, ()> {
    ...
    private static func getIdempotent<MonSt, EqF>(_ monadState : MonSt, _ eq : EqF) where MonSt : MonadState, MonSt.F == F, MonSt.S == Int, EqF : Eq, EqF.A == HK<F, Int> {
    ...
    private static func setTwice<MonSt, EqF>(_ monadState : MonSt, _ eq : EqF) where MonSt : MonadState, MonSt.F == F, MonSt.S == Int, EqF : Eq, EqF.A == HK<F, ()> {
    ...
    private static func setGet<MonSt, EqF>(_ monadState : MonSt, _ eq : EqF) where MonSt : MonadState, MonSt.F == F, MonSt.S == Int, EqF : Eq, EqF.A == HK<F, Int> {
    ...
    private static func getSet<MonSt, EqF>(_ monadState : MonSt, _ eq : EqF) where MonSt : MonadState, MonSt.F == F, MonSt.S == Int, EqF : Eq, EqF.A == HK<F, ()> {
